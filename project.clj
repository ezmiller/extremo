(defproject extremo "0.1.0-SNAPSHOT"
   ...
   {:cljsbuild
    {:builds {:dev
              {:source-paths ["env/dev" "src"]
               :figwheel     true
               :compiler     {:main          extremo.app
                              :output-to     "target/out/extremo.js"
    ...
    {:builds
     {:test
      {:source-paths ["env/test" "src" "test"]
       :compiler     {:main extremo.app
                            :output-to     "target/test/extremo.js"
                            :target        :nodejs
                            :optimizations :none
                            :source-map    true
                            :pretty-print  true}}}}
    ...
    {:builds
     {:release
      {:source-paths ["env/prod" "src"]
       :compiler     {:main          extremo.app
                      :output-to     "target/release/extremo.js"
                      :target        :nodejs
